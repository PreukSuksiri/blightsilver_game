...
const TEST_PATH := "res://campaign/scenes/ch0_s1_pre_DEMO_PART2.json"
#const TEST_PATH := "res://exploration/vn/vn_ch0_s1_blackout_library/vn_node_break_room_invest_4_0.json"
