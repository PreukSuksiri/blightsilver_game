...
##     "give_credits"— send int(value) credits to mailbox (value = amount;
...
##                                           is taken in this room. Also gated by "conditions":
##                                           unmet Conditions stall the spot (no lens flare,
##                                           no hitbox) even after shutter. When both shutter
##                                           and Conditions pass: invisible hitbox-only in the
##                                           room; Polaroid photos show a lens flare until
##                                           hide_after_interact dismisses it.
