...
func _load_characters() -> void:
	var defs: Array = [
		...
		["Echo Bringer", CharacterData.Affinity.COSMIC, 55, 40, 850,
		...
		["Electrogazer", CharacterData.Affinity.COSMIC, 45, 45, 790,
		...
		["Golden Senju", CharacterData.Affinity.DIVINE, 15, 0, 200,
			...
			{"max_attacks": 3},
			"Once per turn, if attacked non-character card, this card : can attack 1 more times",
			CharacterData.Rarity.UNCOMMON],
		...
		["Lab Bloater", CharacterData.Affinity.BIO, 20, 85, 800,
			...
			{},
			"With Mutagen Flag: destroy the attacker in Reckoning. Foe pay no cost.",
			CharacterData.Rarity.LEGENDARY],

		["Lab Crawler", CharacterData.Affinity.BIO, 90, 45, 1200,
			CharacterData.AbilityType.MUTAGEN_IMMEDIATE_ATTACK,
			{},
			"With Mutagen Flag: gain 1 more attack once per turn",
			CharacterData.Rarity.EXOTIC],
		...
		["Pit Lord", CharacterData.Affinity.CHAOS, 120, 100, 1250,
			CharacterData.AbilityType.DESTROYED_IF_BATTLES_DIVINE,
			{},
			"his card is destroyed if battle with Divine Character. After this card attacked, halve its ATK&DEF permanently",
			CharacterData.Rarity.EXOTIC],

		["Plant-29", CharacterData.Affinity.BIO, 45, 75, 900,
		...
		["Rotten Shrieker", CharacterData.Affinity.BIO, 50, 30, 450,
			...
			{"amount": 10},
			"-10 ATK permanently at your turn’s end",
			CharacterData.Rarity.UNCOMMON,
			true],
		...
		["Horn Face", CharacterData.Affinity.COSMIC, 85, 60, 1350,
			...
			"After a successful attack, flip a coin. If head, this card can attack again. Can do up to 3 times.",
			CharacterData.Rarity.EXOTIC],

		["Hyperspeed Saucer", CharacterData.Affinity.COSMIC, 80, 40, 850,
			CharacterData.AbilityType.PERM_BOOST_END_OF_TURN,
			{"atk": 10, "def": 10},
			"Permanently increase this card's ATK and DEF by 10 at the end of each of your turns.",
			CharacterData.Rarity.LEGENDARY],

		["Ironclad Sentinel", CharacterData.Affinity.ANIMA, 55, 95, 1100,
			CharacterData.AbilityType.IMMUNE_TO_TECH_DESTRUCTION, {},
			"Immune to 0-cost Traps. This Character cannot be destroyed by Tech Cards.",
			CharacterData.Rarity.EXOTIC],
		...
		["Slim Gray Trooper", CharacterData.Affinity.COSMIC, 45, 45, 750,
			...
			"+30 ATK and DEF if 10 or more cells on your side are revealed.",
			CharacterData.Rarity.UNCOMMON],
	]
...
func _load_traps() -> void:
	var defs: Array = [
		...
		["Decoy Puppet", 500, TrapData.TrapEffectType.CANCEL_ATTACKER_ATTACK,
			{},
			"This turn, foe cannot attack again.",
			CharacterData.Rarity.UNCOMMON,
			true],
		...
		["Hard Scale", 700, TrapData.TrapEffectType.TEMP_DEF_BOOST_ONE_OWN,
			{"def": 5},
			"+5 DEF to all of your card until this turn's end",
			CharacterData.Rarity.COMMON,
			true],
		...
		["Self-destruct", 0, TrapData.TrapEffectType.SELF_DESTROY_TEMP_ATK_BOOST,
			{"atk": 10},
			"Select 1 of your character. +10 ATK until your next turn's end, but also destroy it. You pay no cost.",
			CharacterData.Rarity.UNCOMMON,
			true],
...
func _load_tech_cards() -> void:
	var defs: Array = [
		...
		["Accident", 1000, TechCardData.TechEffectType.DESTROY_FACEUP_NO_CRYSTAL_LOSS,
			{}, "",
			"Destroy 1 face-up foe's card. If there is no face-up card, foe must chooses the target. Foe pay no cost.",
			CharacterData.Rarity.RARE,
			true],

		["Bribe", 0, TechCardData.TechEffectType.OPPONENT_REVEALS_OR_GAINS,
			{"crystal_reward": 700}, "",
			"Your foe can choose to reveal a character card and receive 700 crystals or do nothing",
			CharacterData.Rarity.RARE],
		...
		["Resurrection", 1500, TechCardData.TechEffectType.REVIVE_CHARACTER_NO_ATK,
			{}, "",
			"Once, revive 1 character. It has no ATK,DEF, or ability.",
			CharacterData.Rarity.LEGENDARY],

		["Siege Cannon", 1000, TechCardData.TechEffectType.OPPONENT_NEXT_DEFENDER_DESTROYED,
			{}, "",
			"Until the end of this turn, once, foe’s defending character is destroyed.",
			CharacterData.Rarity.EXOTIC],
