...
Ability: With Mutagen Flag, destroy the attacker after this card has been attacked. Also, the owner of this card does not pay Crystal Cost when it is destroyed.
Test Cases:
...
Step 3: Trigger combat scenario described: With Mutagen Flag, destroy the attacker after this card has been attacked. Also, the owner of this card does not pay Crystal Cost when it is destroyed.
Expected Result:
...
Description:
Crystal interaction — Lab Bloater crystal gain/loss/drain.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Lab Bloater' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
...
Steps:
Step 1: Trigger ability: With Mutagen Flag, destroy the attacker after this card has been attacked. Also, the owner of this card does not pay Crystal Cost when it is destroyed.
Expected Result:
- Crystal delta matches card text; respects insufficient-crystal edge cases where payment is optional.

Test Case ID: TC-Lab-Bloater-006
Description:
Optional crystal pay — Lab Bloater with insufficient crystals.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Lab Bloater' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
...
Steps:
Step 1: Enter battle with Lab Bloater; decline/accept crystal payment prompt.
Expected Result:
- Insufficient crystals: payment skipped, no bonus. Sufficient: bonus applies.

Test Case ID: TC-Lab-Bloater-007
Description:
...
Type: Character
Stats: Cost=1300 ATK=90 DEF=45 Affinity=Bio
Ability: With Mutagen Flag, this card can attack twice
Test Cases:
...
Step 2: Verify mutagen flag icon appears on card.
Step 3: Trigger combat scenario described: With Mutagen Flag, this card can attack twice
Expected Result:
- has_mutagen_flag is true (not merely 'mutogen' string in flags array).
- Mutagen-granted ability activates per card text.
...
Description:
Multi-attack — Lab Crawler chained attacks.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Lab Crawler' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Ensure attacks_remaining > 0.
- Meet condition for extra attack (With Mutagen Flag, this card can attack twice).
Steps:
...
Test Case ID: TC-Lab-Crawler-006
Description:
...
Ability: With Mutagen Flag, this card gain +25 ATK against Nature or Anima Characters.
Test Cases:
...
Step 2: Verify mutagen flag icon appears on card.
Step 3: Trigger combat scenario described: With Mutagen Flag, this card gain +25 ATK against Nature or Anima Characters.
Expected Result:
- has_mutagen_flag is true (not merely 'mutogen' string in flags array).
- Mutagen-granted ability activates per card text.
...
Card Name: Plant 29
Type: Character
Stats: Cost=800 ATK=45 DEF=75 Affinity=Bio
Ability: At the start of your turn, select 1 face-up opponent’s card. Flip a coin, if head, put a venom flag on it. If tail, put mutagen flag on it.
Test Cases:
...
Step 2: Verify mutagen flag icon appears on card.
Step 3: Trigger combat scenario described: At the start of your turn, select 1 face-up opponent’s card. Flip a coin, if head, put a venom flag on it. If tail, put mutagen flag on it.
Expected Result:
- has_mutagen_flag is true (not merely 'mutogen' string in flags array).
- Mutagen-granted ability activates per card text.
...
Ability: At battle calculation, destroy Chaos card
Test Cases:
...
Card Name: Pit Lord
Type: Character
Stats: Cost=1200 ATK=120 DEF=100 Affinity=Chaos
Ability: his card is destroyed if battle with Divine Character. After this card attacked, halve its ATK and DEF permanently
Test Cases:
...
Type: Character
Stats: Cost=850 ATK=70 DEF=90 Affinity=Divine
...
Type: Character
Stats: Cost=600 ATK=45 DEF=45 Affinity=Cosmic
...
Ability: +50 ATK for each other face-up Chaos card on their own field. If it battles with Divine Character, destroy this card.
Test Cases:
...
Ability: Destroy is card when battling with Divine card. At battle calculation, -5 ATK and DEF to the defender permanently. Also +ATK and DEF to this card permamently
Test Cases:
...
Description:
Defend scenario — Vampire Duchess as defender.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Vampire Duchess' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Opponent attacks Vampire Duchess.
Steps:
...
Test Case ID: TC-Vampire-Duchess-004
Description:
...
Type: Character
Stats: Cost=1100 ATK=90 DEF=80 Affinity=Cosmic
...
Type: Character
Stats: Cost=850 ATK=85 DEF=50 Affinity=Nature
Ability: At the end of this turn, select 1 face-up card on your opponent’s field. Put 1 venom flag on it.
Test Cases:
...
Type: Character
Stats: Cost=900 ATK=75 DEF=60 Affinity=Anima
Ability: This Character cannot be destroyed by Traps.
Test Cases:
...
Ability: At battle calculation, flip a coin, if head, swap this card’s position with any of character card on their own field
Test Cases:
...
Ability: Whenever your opponent lose crystal, they lose 20 more crystals
Test Cases:
...
- Record crystal totals before trigger.
Steps:
Step 1: Trigger ability: Whenever your opponent lose crystal, they lose 20 more crystals
Expected Result:
- Crystal delta matches card text; respects insufficient-crystal edge cases where payment is optional.
...
Card Name: Succubus
Type: Character
Stats: Cost=400 ATK=10 DEF=30 Affinity=Chaos
Ability: Once, if this card survive battle, gain ATK and DEF equal to the card it battled
Test Cases:
...
Ability: Once, after this card defended successfully, it permanently lose -40 DEF and permanently gain +40 ATK against attacker’s affinity
Test Cases:
...
Ability: At battle calculation, you can pay 100 crystal. This card gain +10 ATK
Test Cases:
...
- Record crystal totals before trigger.
Steps:
Step 1: Trigger ability: At battle calculation, you can pay 100 crystal. This card gain +10 ATK
Expected Result:
- Crystal delta matches card text; respects insufficient-crystal edge cases where payment is optional.
...
Ability: If this card attacks a character card, the target is unable to attack until the end of their turn.
Test Cases:
...
Ability: If ‘Miner’ card will be destroyed, you can destroy this card instead. Can be triggered face-down
Test Cases:
...
Type: Character
Stats: Cost=500 ATK=20 DEF=20 Affinity=Chaos
Ability: If a 'Vampire' card will be destroyed, destroy this card instead. Can be triggered face-down.
Test Cases:
...
Type: Character
Stats: Cost=800 ATK=80 DEF=0 Affinity=Arcane
...
Type: Character
Stats: Cost=960 ATK=40 DEF=90 Affinity=Divine
...
Type: Character
Stats: Cost=500 ATK=55 DEF=40 Affinity=Cosmic
...
Ability: If this card attacked non-character card, this card can attack again, up to 3 times.
Test Cases:
...
Description:
Multi-attack — Golden Senju chained attacks.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Golden Senju' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Ensure attacks_remaining > 0.
- Meet condition for extra attack (If this card attacked non-character card, this card can attack again, up to 3 times.).
Steps:
Step 1: After first successful attack, attempt second attack same turn.
Expected Result:
- Second attack allowed once per text; attacks_remaining decrements correctly.

Test Case ID: TC-Golden-Senju-004
Description:
...
Ability: Whenever opponent’s tech card is activated, +10 ATK and DEF until the start of your next turn
Test Cases:
...
Ability: Character that destroyed this card cannot attack until the end of your opponent’s turn.
Test Cases:
...
Description:
End-of-turn — Skeleton Grappler turn boundary effect.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Skeleton Grappler' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Skeleton Grappler survives to end of relevant turn.
Steps:
Step 1: End turn; observe end-of-turn processing.
Expected Result:
- Turn-end stat changes, flags, or self-destruct occur as specified.
...
Test Case ID: TC-Skeleton-Grappler-005
Description:
...
Ability: If this card defended, the attacker card cannot attack on the next of opponent’s turn
Test Cases:
...
Description:
Attack lock — Stinky Insect or target attack restriction.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Stinky Insect' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
...
Test Case ID: TC-Stinky-Insect-005
Description:
...
Ability: While this card is face-up, at the end of your opponent’s turn, swap its ATK and DEF
Test Cases:
...
Description:
End-of-turn — Vile Creeper turn boundary effect.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Vile Creeper' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Vile Creeper survives to end of relevant turn.
Steps:
Step 1: End turn; observe end-of-turn processing.
Expected Result:
- Turn-end stat changes, flags, or self-destruct occur as specified.
...
Test Case ID: TC-Vile-Creeper-006
Description:
...
Ability: +10 ATK at the end of your turn. Remove the bonus after battle calculation.
Test Cases:
...
Description:
End-of-turn — Hands in the Attic turn boundary effect.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Hands in the Attic' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Hands in the Attic survives to end of relevant turn.
Steps:
Step 1: End turn; observe end-of-turn processing.
Expected Result:
- Turn-end stat changes, flags, or self-destruct occur as specified.

Test Case ID: TC-Hands-in-the-Attic-004
Description:
...
Type: Character
Stats: Cost=900 ATK=120 DEF=60 Affinity=Nature
...
Test Case ID: TC-Moon-Tribe-Twin-Blades-001
Description:
Happy path — Moon Tribe Twin Blades attacks and wins a standard battle.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Moon Tribe Twin Blades' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Place Moon Tribe Twin Blades face-up on Player 0 row 2 col 2 (center-adjacent).
- Place opponent Wandering Swordsman (60 ATK / 60 DEF) face-up at Player 1 row 2 col 2.
Steps:
Step 1: End setup phase. Player 0 selects Moon Tribe Twin Blades as attacker targeting opponent character.
Step 2: Confirm battle calculation overlay shows effective ATK/DEF.
Step 3: Complete the attack and observe post-battle state.
Expected Result:
- Moon Tribe Twin Blades participates in battle resolution without errors.
- Winner/loser destruction and crystal loss follow standard rules.
- Ability-related messages appear in battle log if applicable.

Test Case ID: TC-Moon-Tribe-Twin-Blades-002
Description:
Edge — Moon Tribe Twin Blades placed face-down, revealed on attack.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Moon Tribe Twin Blades' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Place Moon Tribe Twin Blades face-down on Player 0 field.
- Opponent has a face-down defender.
Steps:
Step 1: Attack with another unit or reveal Moon Tribe Twin Blades via Tech (Spy/Radar) first if needed.
Step 2: Attack opponent cell with Moon Tribe Twin Blades.
Expected Result:
- Moon Tribe Twin Blades reveals correctly on attack.
- Face-down state does not break ability triggers that depend on exposure timing.

Test Case ID: TC-Moon-Tribe-Twin-Blades-003
Description:
Coin flip — Moon Tribe Twin Blades ability resolution.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Moon Tribe Twin Blades' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Note: coin flip uses RNG; run multiple iterations or log outcomes.
Steps:
Step 1: Trigger battle/turn event that activates coin flip for Moon Tribe Twin Blades.
Expected Result:
- On heads: positive branch occurs. On tails: alternate branch or no effect per card text.

Test Case ID: TC-Moon-Tribe-Twin-Blades-004
Description:
Multi-attack — Moon Tribe Twin Blades chained attacks.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Moon Tribe Twin Blades' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
...
Test Case ID: TC-Moon-Tribe-Twin-Blades-005
Description:
Edge — low crystals during Moon Tribe Twin Blades battle.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Moon Tribe Twin Blades' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Set Player 0 crystals to 100.
Steps:
Step 1: Attack/defend with Moon Tribe Twin Blades and lose card (crystal cost payment).
Expected Result:
- Crystal total floors at 0; game does not crash on bankruptcy.
...
Ability: When this card defends, the attacker permanently loses 10 ATK and DEF.
Test Cases:
...
Ability: When it successfully attacked, reveal 1 cell on your opponent’s field
Test Cases:
...
Type: Character
Stats: Cost=1400 ATK=80 DEF=80 Affinity=Anima
Ability: +20 ATK and DEF for each other face-up Anima card on their own field
Test Cases:
...
Type: Character
Stats: Cost=750 ATK=75 DEF=0 Affinity=Divine
...
Ability: When this card attacks dead end, reveal 1 of your opponent’s cell
Test Cases:
...
Type: Character
Stats: Cost=900 ATK=45 DEF=45 Affinity=Nature
Ability: +15 ATK and DEF for each other face-up Nature card on your field
Test Cases:
...
Ability: When this card attacks a trap, reveal 1 of your opponent’s cell
Test Cases:
...
Card Name: Night Whisperor
Type: Character
Stats: Cost=900 ATK=30 DEF=30 Affinity=Chaos
Ability: +30 ATK and DEF for each face-up ‘wisp’ card on their own field
Test Cases:


Test Case ID: TC-Night-Whisperor-001
Description:
Happy path — Night Whisperor attacks and wins a standard battle.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Night Whisperor' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Place Night Whisperor face-up on Player 0 row 2 col 2 (center-adjacent).
- Place opponent Wandering Swordsman (60 ATK / 60 DEF) face-up at Player 1 row 2 col 2.
Steps:
Step 1: End setup phase. Player 0 selects Night Whisperor as attacker targeting opponent character.
Step 2: Confirm battle calculation overlay shows effective ATK/DEF.
Step 3: Complete the attack and observe post-battle state.
Expected Result:
- Night Whisperor participates in battle resolution without errors.
- Winner/loser destruction and crystal loss follow standard rules.
- Ability-related messages appear in battle log if applicable.

Test Case ID: TC-Night-Whisperor-002
Description:
Edge — Night Whisperor placed face-down, revealed on attack.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Night Whisperor' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Place Night Whisperor face-down on Player 0 field.
- Opponent has a face-down defender.
Steps:
Step 1: Attack with another unit or reveal Night Whisperor via Tech (Spy/Radar) first if needed.
Step 2: Attack opponent cell with Night Whisperor.
Expected Result:
- Night Whisperor reveals correctly on attack.
- Face-down state does not break ability triggers that depend on exposure timing.

Test Case ID: TC-Night-Whisperor-003
Description:
Exposure edge — Night Whisperor face-up vs face-down states.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Night Whisperor' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Run once with defender face-up before attack; once face-down until reveal.
Steps:
Step 1: Attack with Night Whisperor each time.
Expected Result:
- Exposure-dependent ATK/DEF modifiers differ correctly between scenarios.

Test Case ID: TC-Night-Whisperor-004
Description:
Edge — low crystals during Night Whisperor battle.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Night Whisperor' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Set Player 0 crystals to 100.
Steps:
Step 1: Attack/defend with Night Whisperor and lose card (crystal cost payment).
Expected Result:
- Crystal total floors at 0; game does not crash on bankruptcy.
...
Card Name: Leech Man
Type: Character
Stats: Cost=850 ATK=60 DEF=40 Affinity=Bio
Ability: +20 DEF permanently each time it performed attack and survive
Test Cases:
...
Ability: If this card attacks a dead end card, you receive 20 crystals
Test Cases:
...
- Record crystal totals before trigger.
Steps:
Step 1: Trigger ability: If this card attacks a dead end card, you receive 20 crystals
Expected Result:
- Crystal delta matches card text; respects insufficient-crystal edge cases where payment is optional.
...
Ability: +5 ATK if at the end of opponent’s turn, this card survived.
Test Cases:
...
Description:
End-of-turn — Dark Blob turn boundary effect.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Dark Blob' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Dark Blob survives to end of relevant turn.
Steps:
Step 1: End turn; observe end-of-turn processing.
Expected Result:
- Turn-end stat changes, flags, or self-destruct occur as specified.

Test Case ID: TC-Dark-Blob-004
Description:
...
Ability: Once, if destroyed a card, this card an attack 1 more time
Test Cases:
...
Ability: After this card attacks, reveal 1 of your opponent’s cell
Test Cases:
...
Type: Character
Stats: Cost=300 ATK=30 DEF=20 Affinity=Cosmic
Ability: Gain 40 crystals each time opponent’s grid is revealed
Test Cases:
...
- Record crystal totals before trigger.
Steps:
Step 1: Trigger ability: Gain 40 crystals each time opponent’s grid is revealed
Expected Result:
- Crystal delta matches card text; respects insufficient-crystal edge cases where payment is optional.
...
Type: Character
Stats: Cost=150 ATK=20 DEF=5 Affinity=Chaos
Ability: Once, attack again if this card attacked dead end card
Test Cases:
...
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Ensure attacks_remaining > 0.
- Meet condition for extra attack (Once, attack again if this card attacked dead end card).
Steps:
Step 1: After first successful attack, attempt second attack same turn.
Expected Result:
- Second attack allowed once per text; attacks_remaining decrements correctly.
...
Type: Character
Stats: Cost=700 ATK=50 DEF=45 Affinity=Arcane
Ability: +20 ATK and DEF if there is Union card on your field
Test Cases:
...
Ability: At battle calculation, flip a coin, if head, +10 ATK
Test Cases:
...
Type: Character
Stats: Cost=780 ATK=65 DEF=65 Affinity=Chaos
...
Ability: Destroy is card when battling with Divine card
Test Cases:
...
Ability: At battle calculation, -15 ATK to the attacker
Test Cases:
...
Ability: If this card is exposed, it defense becomes 0
Test Cases:
...
Ability: +10 DEF and -10 ATK while performing defense.
Test Cases:
...
Ability: +10 ATK and -10 DEF while performing attack.
Test Cases:
...
Ability: -10 ATK permanently at the end of your turn
Test Cases:
...
Test Case ID: TC-Armored-Money-001
Description:
Happy path — Armored Money attacks and wins a standard battle.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Armored Money' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Place Armored Money face-up on Player 0 row 2 col 2 (center-adjacent).
- Place opponent Wandering Swordsman (60 ATK / 60 DEF) face-up at Player 1 row 2 col 2.
Steps:
Step 1: End setup phase. Player 0 selects Armored Money as attacker targeting opponent character.
Step 2: Confirm battle calculation overlay shows effective ATK/DEF.
Step 3: Complete the attack and observe post-battle state.
Expected Result:
- Armored Money participates in battle resolution without errors.
- Winner/loser destruction and crystal loss follow standard rules.
- Ability-related messages appear in battle log if applicable.

Test Case ID: TC-Armored-Money-002
Description:
Edge — Armored Money placed face-down, revealed on attack.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Armored Money' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Place Armored Money face-down on Player 0 field.
- Opponent has a face-down defender.
Steps:
Step 1: Attack with another unit or reveal Armored Money via Tech (Spy/Radar) first if needed.
Step 2: Attack opponent cell with Armored Money.
Expected Result:
- Armored Money reveals correctly on attack.
- Face-down state does not break ability triggers that depend on exposure timing.

Test Case ID: TC-Armored-Money-003
Description:
Exposure edge — Armored Money face-up vs face-down states.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Armored Money' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Run once with defender face-up before attack; once face-down until reveal.
Steps:
Step 1: Attack with Armored Money each time.
Expected Result:
- Exposure-dependent ATK/DEF modifiers differ correctly between scenarios.

Test Case ID: TC-Armored-Money-004
Description:
Edge — low crystals during Armored Money battle.
Preconditions:
- Start a new battle (Daily Dungeon or battle_test scene). Both players begin with 5000 crystals unless testing low-crystal edge cases.
- Ensure 'Armored Money' is in the active player's deck/hand and loaded in CardDatabase.
- Board is 5×5 per side; place supporting cards face-down unless the test requires face-up exposure.
- Set Player 0 crystals to 100.
Steps:
Step 1: Attack/defend with Armored Money and lose card (crystal cost payment).
Expected Result:
- Crystal total floors at 0; game does not crash on bankruptcy.
...
Card Name: War Genie 
Type: Character
Stats: Cost=1000 ATK=100 DEF=80 Affinity=Arcane
...
Type: Character
Stats: Cost=600 ATK=65 DEF=25 Affinity=Chaos
...
Type: Character
Stats: Cost=850 ATK=75 DEF=25 Affinity=Nature
Ability: +10 ATK per shark card on the field
Test Cases:
...
Type: Character
Stats: Cost=1200 ATK=100 DEF=70 Affinity=Arcane
Ability: +50 ATK and DEF against Anima
Test Cases:
...
Ability: +5 ATK and DEF vs Non-Anima
Test Cases:
...
Type: Character
Stats: Cost=700 ATK=45 DEF=55 Affinity=Arcane
Ability: +30 ATK and DEF vs Arcane
Test Cases:
...
Ability: +20 ATK and DEF vs Nature
Test Cases:
...
Ability: +10 ATK and DEF vs Nature
Test Cases:
...
Ability: +5 ATK and DEF vs Arcane
Test Cases:
...
Type: Character
Stats: Cost=700 ATK=60 DEF=85 Affinity=Nature
Ability: None
Test Cases:
...
Type: Character
Stats: Cost=550 ATK=70 DEF=30 Affinity=Nature
Ability: None
Test Cases:
...
Card Name: Gryphon
Type: Character
Stats: Cost=1200 ATK=100 DEF=85 Affinity=Nature
Ability: None
Test Cases:
...
Card Name: Space Boy
Type: Character
Stats: Cost=750 ATK=75 DEF=65 Affinity=Cosmic
Ability: None
Test Cases:
